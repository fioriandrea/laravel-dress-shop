...
<section class="product-categories text-light text-center my-5">
    @foreach($categories as $category)
        <a href="{{ action('ProductController@getProductList', ['category' => $category, 'keyword' => '']) }}" class="bg-cover product-category" style="background-image: url(img/{{ strtolower($category) }}_card.jpg);">
